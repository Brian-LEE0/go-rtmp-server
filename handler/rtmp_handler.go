...
// func (h *Handler) NextflvFileCreate() {
// 	h.idx++
// 	p := filepath.Join(
// 		os.TempDir(),
// 		filepath.Clean(filepath.Join("./", fmt.Sprintf("%s%d.flv", h.publishingName, h.idx))),
// 	)
// 	log.Print("FLV file path: ", p)
// 	f, err := os.OpenFile(p, os.O_CREATE|os.O_WRONLY, 0666)
// 	if err != nil {
// 		log.Printf("Failed to create flv file: %v", err)
// 	}
// 	h.flvFile = f
// 	flvFilePath = append(flvFilePath, p)

// 	enc, err := flv.NewEncoder(f, flv.FlagsAudio|flv.FlagsVideo)
// 	if err != nil {
// 		_ = f.Close()
// 		log.Printf("Failed to create flv encoder: %v", err)
// 	}
// 	h.flvEnc = enc
// }
...
func (h *Handler) OnVideo(timestamp uint32, payload io.Reader) error {
	...
	// if fi, err := h.flvFile.Stat(); err == nil {
	// 	if fi.Size() > fileSize {
	// 		h.NextflvFileCreate()
	// 	}
	// }
